...
import { requestJoinLeagueByCode } from "@/app/actions/leagues";
...
type Props = {
  ...
  /** Signed-in user’s onboarding complete */
  onboarded: boolean;
  signedIn: boolean;
  isMember: boolean;
    ...
    <Button
      ...
      onClick={() => {
        startTransition(async () => {
          const res = await requestJoinLeagueByCode(leagueCode);
